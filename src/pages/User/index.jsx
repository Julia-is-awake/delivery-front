...
function Users() {
  ...
  const getData = async () => {
    try {
      const rests = await api.get("/user/listar");
  ...
  const deleteItem = async () => {
    try {
      const response = await api.delete(`/user/deletar/${itemId}`);
  ...
  const editItem = async () => {
    ...
    const response = await api.post(`/user/editar`, item);
    setUsers(response.data);
  ...
  const createItem = async () => {
    ...
    const response = await api.post(`/user/cadastrar`, item);
  ...
  const searchItem = async () => {
    const item = await api.get(`/user/${itemId}`);
    setUser(item.data);
  };
      ...
      <div className="users-container">
        <p>
          <button
            ...
            data-bs-target="#usersListar"
            aria-expanded="false"
            aria-controls="usersListar"
          >
            Users
          </button>
        </p>

        <div className="collapse mb-3" id="usersListar">
          <div className="card card-body d-block">
              ...
              <div className="modal-dialog">
                <div className="modal-content">
                  ...
                  <div className="modal-body">
                    <div className="users-listar-item">
                      <div
                        className="users-listar-imagem"
                        style={{ backgroundImage: `url(${user.imagem})` }}
                      ></div>
                      <div className="users-listar-descricao">
                        <h5>{user.nome}</h5>
            ...
            <div className="users-listar-container">
              {users.map((item) => (
                <div key={item.id} className="users-listar-item">
                  <div
                    className="users-listar-imagem"
